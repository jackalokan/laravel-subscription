...
/**
 * Abovesky\Subscription\Models\PlanSubscription.
 *
 * @property int                 $id
 ...
 *
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription byPlanId($planId)
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription findEndedPeriod()
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription findEndedTrial()
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription findEndingPeriod($dayRange = 3)
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription findEndingTrial($dayRange = 3)
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription ofSubscriber(\Illuminate\Database\Eloquent\Model $subscriber)
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription whereDeletedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription whereDescription($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription whereEndsAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription whereTitle($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription wherePlanId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription whereSlug($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription whereStartsAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription whereTrialEndsAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription whereSubscriberId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\Abovesky\Subscription\Models\PlanSubscription whereSubscriberType($value)
 * @mixin \Eloquent
 */
class PlanSubscription extends Model
{
    ...
    {
        return $this->hasMany(config('abovesky.subscription.models.plan_subscription_usage'), 'subscription_id', 'id');
    }
     ...
     *
     * @param \Abovesky\Subscription\Models\Plan $plan
     *
     * @return $this
     */
     ...
     * @param int    $uses
     *
     * @return \Abovesky\Subscription\Models\PlanSubscriptionUsage
     */
     ...
     * @param int    $uses
     *
     * @return \Abovesky\Subscription\Models\PlanSubscriptionUsage|null
     */
